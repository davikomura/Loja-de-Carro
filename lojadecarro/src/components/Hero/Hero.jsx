            ...
            <div className="container min-h-[620px] flex">
                ...
                grid-cols-1 sm:grid-cols-2">
                    ...
                    <div className="order-2 sm:order-1 space-y-5 sm:pr-32">
                        ...
                        <p data-aos="fade-up" 
                        data-aos-delay="1000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione
                        veritatis explicabo quibusdam quae reprehenderit ab{" "}</p>
                        <button
                            data-aos="fade-up" 
                            data-aos-duration="1500"
                            className="btn bg-primary text-black 
                            px-6 py-2 rounded-md hover:bg-primary/80 duration-300"
                        >
                            Get Starded
                        </button>
                    </div>
